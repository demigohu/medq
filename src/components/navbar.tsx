...
export function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="w-full fixed top-6 left-1/2 transform -translate-x-1/2 z-50 px-4 sm:px-0">
        <div className="max-w-4xl mx-auto px-6 py-3 rounded-full bg-[#121212]/80 backdrop-blur supports-backdrop-filter:bg-[#121212]/60 border border-[#252525]/40 shadow-lg">
